...
export default function AboutPage() {
  return <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
    ...
    <div className="mt-6 space-y-5 leading-7 text-[var(--color-muted-fg)]">
      <p>Hanuja, bağımsız üretici ve tasarımcıların ürünlerini müşterilerle buluşturan bir elektronik ticaret pazaryeridir. Platform; ürün keşfi, güvenli ödeme, sipariş takibi, sözleşme ve satış sonrası destek süreçlerini tek yerde sunar.</p>
      ...
      <p>Satış sözleşmesinde her ürünün tasarımcısı ayrıca gösterilir. Hanuja, pazaryeri hizmet sağlayıcısı olarak ödeme ve sipariş akışını işletir; tasarımcıların başvuru ve belge kontrollerini gerçekleştirir.</p>
