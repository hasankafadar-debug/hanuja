...
const ACTION_LABELS: Record<string, string> = {
  ...
  seller_deleted: 'Satıcı kalıcı silindi',
  product_unlisted: 'Ürün yayından kaldırıldı',
  product_deleted: 'Ürün kalıcı silindi',
...
const ACTION_COLORS: Record<string, string> = {
  ...
  seller_deleted: 'var(--color-destructive)',
  product_unlisted: '#f59e0b',
  product_deleted: 'var(--color-destructive)',
