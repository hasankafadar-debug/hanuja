...
- Web/customer/storefront: `https://www.hanuja.com.tr`
- Seller panel: `https://satici.hanuja.com.tr`
- Admin panel: `https://admin.hanuja.com.tr`
- Invoice inbound mail: `fatura.hanuja.com.tr`

## Required Production Env

- `INVOICE_ALIASING_ENABLED=true`
- `INBOUND_EMAIL_DOMAIN=fatura.hanuja.com.tr`
- `POSTMARK_INBOUND_WEBHOOK_USER`
- `POSTMARK_INBOUND_WEBHOOK_PASS`

## Postmark Setup

- Point MX for `fatura.hanuja.com.tr` to Postmark inbound.
- Configure Postmark inbound webhook to `https://www.hanuja.com.tr/api/inbound/postmark`.
